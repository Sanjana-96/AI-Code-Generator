...
// //       const text = response.text; // per @google/genai docs
...
//         body: JSON.stringify({
//           prompt: buildPrompt(prompt, framework),
//           frameworkLabel: framework.label, // optional for backend
//         }),
//       });
...
//       const cleanedCode = extractCode(data.text || "");
//       if (!cleanedCode) {
...
const Home = () => {
  ...
  const getResponse = async () => {
    console.log("getResponse clicked"); // for debugging
